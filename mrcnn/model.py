...
# Resolve:
#  replaced data_generator function with a subclass of 
#  keras.utils.Sequence to avoid duplicate data when multiprocessing=True
# ref: https://github.com/matterport/Mask_RCNN/pull/1611/files
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "mask_rcnn_{}_*epoch*.h5".format(
            self.config.NAME.lower()))
        # Fixed file name. Save ONLY one weights.
        self.checkpoint_path = self.checkpoint_path.replace(
            "*epoch*", "0001")
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.ModelCheckpoint(self.checkpoint_path, monitor='loss',
